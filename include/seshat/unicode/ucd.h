...
sh_gc_t sh_char_gc(sh_char ch);

sh_property_name sh_gc_property_value_name(sh_gc_t gc);

sh_hst_t sh_char_hst(sh_char ch);

sh_property_name sh_hst_property_value_name(sh_hst_t hst);

sh_string* sh_char_na(sh_char ch);


void sh_gc_debug(sh_gc_t gc);
