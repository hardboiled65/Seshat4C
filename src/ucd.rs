...
#[no_mangle]
pub extern "C" fn sh_char_bidi_c(ch: sh_char) -> bool {
    let ch = sh_char_to_rust_char(&ch);
    let bidi_c = ch.bidi_c();
...
#[no_mangle]
pub extern "C" fn sh_char_ci(ch: sh_char) -> bool {
    let ch = sh_char_to_rust_char(&ch);
    let ci = ch.ci();
...
#[no_mangle]
pub extern "C" fn sh_char_dash(ch: sh_char) -> bool {
    let ch = sh_char_to_rust_char(&ch);
    let dash = ch.dash();
